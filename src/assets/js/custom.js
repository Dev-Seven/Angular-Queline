setTimeout(function () {
  ...
  $(".card-btn-toggle").click(function () {
    $("#collapseOne").toggle("slow", function () {
      // Animation complete.
    });
  });
  ...
  // =======================================================
  Chart.plugins.unregister(window.ChartDataLabels);
...
function openNav() {
  ...
  document.getElementById("sidebarMenu").classList.toggle("myn");
}
